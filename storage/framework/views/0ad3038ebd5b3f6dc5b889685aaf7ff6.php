    ...
    <div class="row row-cols-1 row-cols-md-2 g-4">
        <?php $__currentLoopData = $properties; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $property): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="col">
                ...
                <a href="<?php echo e(url('/inventario/'.$property->id)); ?>" class="text-decoration-none text-dark d-block h-100">
                    <div class="card h-100 shadow-sm border-0" style="border-radius: 12px; overflow: hidden; background-color: #ffffff;">
                        ...
                        <div style="width: 100%; height: 260px; overflow: hidden;">
                            <img src="<?php echo e($property->image_fachada); ?>" class="w-100 h-100" style="object-fit: cover;" alt="Fachada">
                        </div>
                        ...
                        <div class="card-body px-3 py-3 d-flex flex-column justify-content-between">
                            <div>
                                <h6 class="text-center fw-bold text-primary mb-1 text-uppercase" style="font-size: 0.95rem; letter-spacing: 0.5px;">
                                    <?php echo e($property->title); ?> | <span class="text-muted fw-normal"><?php echo e(strtok($property->location, ',')); ?></span>
                                </h6>
                            </div>
                            
                            <div class="d-flex justify-content-between align-items-center mt-3 pt-2 border-top">
                                <span class="text-secondary small fw-bold" style="font-size: 0.8rem;">
                                    <?php echo e(strtok($property->dimensions, ' de')); ?>

                                </span>
                                <span class="fw-bold text-dark" style="font-size: 1.05rem;">
                                    $<?php echo e(number_format($property->price)); ?> MXN
                                </span>
                            </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\PROYECTOFINAL\inmobiliaria-pamai\resources\views/inventory/index.blade.php ENDPATH**/ ?>