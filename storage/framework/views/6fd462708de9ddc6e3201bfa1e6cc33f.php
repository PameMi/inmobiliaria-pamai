...
<div class="container my-4">
    <div class="text-center text-white py-3 mb-5" style="background-color: #1a446c; border-radius: 4px; position: relative;">
        <div class="d-flex align-items-center gap-2" style="position: absolute; left: 15px; top: 12px;">
            <a href="<?php echo e(route('cart.view')); ?>" class="btn btn-outline-light btn-sm">←</a>
        </div>
    ...
    <div class="row g-5">
        <div class="col-md-5 border-end">
                    ...
                    <ul class="list-group list-group-flush mb-3">
                        <?php $__currentLoopData = $cart; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <li class="list-group-item d-flex justify-content-between align-items-center px-0 bg-transparent text-secondary small">
                                ...
                                <span class="fw-bold">$<?php echo e(number_format($item['price'], 2)); ?></span>
                            </li>
            ...
            <div class="p-3 text-center my-4" style="background-color: #f8f9fa; border-radius: 8px;">
                <label class="fw-bold text-muted small text-uppercase mb-1 d-block">Total (<?php echo e(count($cart)); ?> Propiedades)</label>
                <h3 class="fw-bold text-dark mb-0">$<?php echo e(number_format($total ?? 0, 2)); ?> <span class="fs-6 text-muted fw-normal">MXN</span></h3>
            </div>
        </div>
        ...
        <div class="col-md-7">
            ...
            <form id="paymentForm">
                ...
                <div class="d-grid gap-2 col-9 mx-auto mt-5">
                    ...
                    <a href="<?php echo e(route('cart.view')); ?>" class="btn btn-light py-2 fw-bold text-uppercase" style="border-radius: 20px; color:#777;">
                        Cancelar
                    </a>
                </div>
            </form>
...
<script>
    ...
    document.getElementById('btnRedirect').addEventListener('click', function() {
        window.location.href = "<?php echo e(route('inventory')); ?>";
    });
</script>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\PROYECTOFINAL\inmobiliaria-pamai\resources\views/inventory/checkout.blade.php ENDPATH**/ ?>