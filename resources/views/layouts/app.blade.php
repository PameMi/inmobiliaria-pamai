            ...
            <div class="container-fluid px-4">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav ms-auto align-items-center gap-4">
                        ...
                        @if(session()->has('admin_logged'))
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-end">
                                    <a class="dropdown-item small fw-bold" href="{{ route('admin.dashboard') }}">Ver Dashboard</a>
                                    <hr class="dropdown-divider">
                                    <a class="dropdown-item text-danger small" href="{{ route('admin.logout') }}">
                                        Cerrar Sesión Admin
                                    </a>
                                </div>
                            </li>
                        @else
                            <li class="nav-item">
                                <a class="nav-link text-warning fw-semibold small" href="{{ route('admin.login-form') }}">Panel Administrador ⚙️</a>
                            </li>
                        @endif
