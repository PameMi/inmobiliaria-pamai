        ...
        <nav class="navbar navbar-expand-md navbar-dark bg-pamai shadow-sm py-2" style="position: relative; z-index: 1000; margin: 0; border: none;">
            <div class="container-fluid px-4">
                ...
                <a class="navbar-brand p-0" href="<?php echo e(url('/')); ?>">
                    <img src="<?php echo e(asset('images/logo.jpeg')); ?>" alt="Logo PAMAI" class="bg-white p-1 rounded" style="height: 55px; width: 55px; object-fit: contain;">
                </a>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav ms-auto align-items-center gap-4">
                        <li class="nav-item">
                            <a class="nav-link text-white fw-semibold small" href="<?php echo e(route('inventory')); ?>">Encuentra una propiedad</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link text-white-50 small" href="#">Contáctanos</a>
                        </li>
                        
                        <!-- ENLACE AL PANEL DE ADMINISTRACIÓN CONFIGURADO CON LOGIN PREVIO -->
                        <?php if(session()->has('admin_logged')): ?>
                            <li class="nav-item dropdown">
                                <a id="adminDropdown" class="nav-link dropdown-toggle text-warning fw-semibold small" href="#" role="button" data-bs-toggle="dropdown">
                                    Admin PAMAI ⚙️
                                </a>
                                <div class="dropdown-menu dropdown-menu-end">
                                    <a class="dropdown-item small fw-bold" href="<?php echo e(route('admin.dashboard')); ?>">Ver Dashboard</a>
                                    <hr class="dropdown-divider">
                                    <a class="dropdown-item text-danger small" href="<?php echo e(route('admin.logout')); ?>">
                                        Cerrar Sesión Admin
                                    </a>
                                </div>
                            </li>
                        <?php else: ?>
                            <li class="nav-item">
                                <a class="nav-link text-warning fw-semibold small" href="<?php echo e(route('admin.login-form')); ?>">Panel Administrador ⚙️</a>
                            </li>
                        <?php endif; ?>

                        <?php if(auth()->guard()->guest()): ?>
                            <li class="nav-item">
                                <a class="nav-link text-white fw-semibold small" href="<?php echo e(route('login')); ?>">Iniciar sesión Cliente/Administrador</a>
                            </li>
                        <?php else: ?>
                            <li class="nav-item dropdown">
...
</html><?php /**PATH D:\PROYECTOFINAL\inmobiliaria-pamai\resources\views/layouts/app.blade.php ENDPATH**/ ?>