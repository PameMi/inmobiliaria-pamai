    ...
    <div class="row g-3 mb-5">
        <div class="col-md-4">
            <div class="card border-0 shadow-sm zoom-container" data-bs-toggle="modal" data-bs-target="#modalFachada">
                <img src="{{ $property->image_fachada }}" class="w-100 zoom-img" style="height: 220px; object-fit: cover;">
        ...
        <div class="col-md-4">
            <div class="card border-0 shadow-sm zoom-container" data-bs-toggle="modal" data-bs-target="#modalComedor">
                <img src="{{ $property->image_comedor }}" class="w-100 zoom-img" style="height: 220px; object-fit: cover;">
        ...
        <div class="col-md-4">
            <div class="card border-0 shadow-sm zoom-container" data-bs-toggle="modal" data-bs-target="#modalRecamara">
                <img src="{{ $property->image_recamara }}" class="w-100 zoom-img" style="height: 220px; object-fit: cover;">
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content border-0 shadow-lg" style="border-radius: 12px; overflow: hidden;">
            <div class="modal-header-custom d-flex justify-content-between align-items-center px-4 py-3 text-white">
                <h5 class="modal-title fw-bold text-uppercase small m-0">FACHADA - {{ $property->title }}</h5>
                <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body p-0">
                <img src="{{ $property->image_fachada }}" class="w-100" style="max-height: 500px; object-fit: cover;">
...
<div class="modal fade" id="modalComedor" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content border-0 shadow-lg" style="border-radius: 12px; overflow: hidden;">
            <div class="modal-header-custom d-flex justify-content-between align-items-center px-4 py-3 text-white">
                <h5 class="modal-title fw-bold text-uppercase small m-0">COMEDOR - {{ $property->title }}</h5>
                <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body p-0">
                <img src="{{ $property->image_comedor }}" class="w-100" style="max-height: 500px; object-fit: cover;">
                <div class="p-4 bg-white">
                    <h6 class="fw-bold text-primary mb-2">Descripción del espacio:</h6>
...
<div class="modal fade" id="modalRecamara" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content border-0 shadow-lg" style="border-radius: 12px; overflow: hidden;">
            <div class="modal-header-custom d-flex justify-content-between align-items-center px-4 py-3 text-white">
                <h5 class="modal-title fw-bold text-uppercase small m-0">RECÁMARA - {{ $property->title }}</h5>
                <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body p-0">
                <img src="{{ $property->image_recamara }}" class="w-100" style="max-height: 500px; object-fit: cover;">
                <div class="p-4 bg-white">
                    <h6 class="fw-bold text-primary mb-2">Descripción del espacio:</h6>
