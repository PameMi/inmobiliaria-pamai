        ...
        <div class="col-md-5">
            ...
            <div class="card border-0 shadow-lg p-4 rounded-4 bg-white">
                <div class="card-body text-center">
                    ...
                    <form method="POST" action="{{ route('login.send') }}" id="magic-form">
                        @csrf

                        <div class="mb-4 text-start">
                            <label for="email" class="form-label small fw-bold text-secondary">Dirección de Correo Electrónico</label>
                            <input id="email" type="email" class="form-control form-control-lg rounded-3 @error('email') is-invalid @enderror" 
