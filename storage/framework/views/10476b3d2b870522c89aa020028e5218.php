...
<div class="container my-4">
    <div class="d-flex justify-content-between align-items-center text-white py-3 px-3 mb-4" style="background-color: #1a446c; border-radius: 4px;">
        <a href="<?php echo e(route('inventory')); ?>" class="btn btn-outline-light btn-sm">←</a>
                                ...
                                <?php $__currentLoopData = $cart; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $id => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr style="border-bottom: 1px solid #f8f9fa;">
                                        <td class="position-relative py-3">
                                            <img src="<?php echo e($item['image']); ?>" class="rounded shadow-sm" style="width: 110px; height: 75px; object-fit: cover;">
                                            <form action="<?php echo e(route('cart.remove', $id)); ?>" method="POST" class="position-absolute" style="top: 10px; left: -5px;">
                                                <?php echo csrf_field(); ?>
                                        ...
                                        <td>
                                            <h6 class="fw-bold m-0 text-dark"><?php echo e($item['title']); ?></h6>
                                            <p class="text-muted small m-0 my-1"><?php echo e($item['dimensions']); ?></p>
                                            <p class="text-muted small m-0 text-truncate" style="max-width: 400px;"><?php echo e($item['rooms_detail']); ?></p>
                                            <span class="fw-bold text-primary" style="font-size: 0.95rem;">$ <?php echo e(number_format($item['price'], 2)); ?> MXN</span>
                                        </td>
            ...
            <div class="col-md-6">
                <div class="card shadow-sm border-0 px-4 py-4 mb-4" style="border-radius: 16px; background-color: #ffffff;">
                    ...
                    <div class="d-flex justify-content-between my-2 text-secondary">
                        <span>Monto de Renta (<?php echo e(count($cart)); ?> unidades):</span>
                    ...
                    <div class="d-flex justify-content-between my-2 text-secondary pb-3 border-bottom">
                        ...
                        <span class="fw-bold">$<?php echo e(number_format($gastosGestion, 2)); ?></span>
                    </div>
                    
                    <div class="d-flex justify-content-between align-items-center my-4">
                        <span class="fw-bold fs-5 text-dark">Total a Pagar (Mensual):</span>
                        <span class="fw-bold fs-4 text-dark">$<?php echo e(number_format($total, 2)); ?></span>
                    </div>

                    <div class="d-flex gap-3 mt-2">
                        <a href="<?php echo e(route('inventory')); ?>" class="btn btn-light w-50 py-2 text-uppercase fw-bold border text-muted" style="border-radius: 12px; font-size: 0.8rem; line-height: 24px;">
                            Volver al detalle
                        </a>
                        <a href="<?php echo e(route('checkout')); ?>" class="btn text-white w-50 py-2 text-uppercase fw-bold text-center" style="background-color: #1a446c; border-radius: 12px; font-size: 0.8rem; line-height: 24px;">
                            Continuar Compra →
                        </a>
                    </div>
                </div>
    ...
    <?php else: ?>
        <div class="text-center my-5 py-5">
            ...
            <a href="<?php echo e(route('inventory')); ?>" class="btn text-white px-4 py-2" style="background-color: #1a446c; border-radius: 8px;">Ir al Inventario</a>
        </div>
    <?php endif; ?>
</div>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content border-0 shadow-lg" style="border-radius: 16px; overflow: hidden;">
            ...
            <div class="modal-body px-4 py-4">
                ...
                <form action="<?php echo e(route('visit.schedule')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\PROYECTOFINAL\inmobiliaria-pamai\resources\views/inventory/cart.blade.php ENDPATH**/ ?>